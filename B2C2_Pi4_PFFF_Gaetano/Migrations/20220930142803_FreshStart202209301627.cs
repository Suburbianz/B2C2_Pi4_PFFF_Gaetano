...
{
    public partial class FreshStart202209301627 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseNumberAddition = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserAchievement", x => new { x.AppUserId, x.AchievementId });
                    table.ForeignKey(
                        name: "FK_AppUserAchievement_Achievements_AchievementId",
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserAchievement_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DescriptionRemark = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CameraReports_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalSchema: "Identity",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserAchievement_AchievementId",
                schema: "Identity",
                table: "AppUserAchievement",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CameraReports_AppUserId",
                schema: "Identity",
                table: "CameraReports",
                column: "AppUserId");
